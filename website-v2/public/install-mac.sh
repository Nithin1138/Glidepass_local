#!/bin/bash
echo "🚀 Installing LANpad for macOS (v1.3.6)..."
echo ""
...
TAG_URL="https://github.com/Nithin1138/Glidepass_local/releases/download/v1.3.6/LANpad_macOS.dmg"
...
if [ "$DOWNLOAD_SUCCESS" = false ] || [ ! -f /tmp/LANpad_macOS.dmg ]; then
    ...
    echo "Please download LANpad directly from GitHub Releases: https://github.com/Nithin1138/Glidepass_local/releases/tag/v1.3.6"
    exit 1
fi
