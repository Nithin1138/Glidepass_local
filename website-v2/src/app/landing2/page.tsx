            ...
            <div className="space-y-6 z-10">
              ...
              <div className="space-y-2 pt-4">
                ...
                <div className="p-3 clay-card shadow-[inset_2px_2px_4px_rgba(0,0,0,0.05)] rounded-xl font-mono text-[9px] text-gray-600 break-all select-all leading-normal border border-white/20">
                  curl -sSL https://lanpad.vercel.app/install-mac.sh | bash
                </div>
              </div>
            </div>

            <button 
              onClick={() => copyCommandToClipboard("curl -sSL https://lanpad.vercel.app/install-mac.sh | bash")}
          ...
          >
            <div className="space-y-6 z-10">
              ...
              <div className="space-y-2 pt-4">
                ...
                <div className="p-3 clay-card shadow-[inset_2px_2px_4px_rgba(0,0,0,0.05)] rounded-xl font-mono text-[9px] text-gray-600 break-all select-all leading-normal border border-white/20">
                  powershell -c "irm https://lanpad.vercel.app/install-windows.ps1 | iex"
                </div>
              </div>
            </div>

            <button 
              onClick={() => copyCommandToClipboard('powershell -c "irm https://lanpad.vercel.app/install-windows.ps1 | iex"')}
